...
public class AdminController {
	...
	public ResponseEntity<?> getAllRestaurant(@PathVariable("pn") int pageNo,@PathVariable("ps") int pageSize,@PathVariable String sortBy,@RequestBody RestaurantRequest request)
	{
		return this.service.viewAllRestaurant(pageNo, pageSize, sortBy, request);
	}
	@PostMapping("/Verify/{pn}/{ps}/{sortBy}")
	public ResponseEntity<?> viewAllVerifiedRestaurant(@PathVariable("pn") int pageNo,@PathVariable("ps") int pageSize,@PathVariable String sortBy,@RequestBody RestaurantRequest request)
	{
		return this.service.viewAllVerifiedRestaurant(pageNo, pageSize, sortBy, request);
	}
	@PostMapping("/UnVerify/{pn}/{ps}/{sortBy}")
	public ResponseEntity<?> viewAllUnVerifiedRestaurant(@PathVariable("pn") int pageNo,@PathVariable("ps") int pageSize,@PathVariable String sortBy,@RequestBody RestaurantRequest request)
	{
		return this.service.viewAllUnVerifiedRestaurant(pageNo, pageSize, sortBy, request);
	}
	@PostMapping("/UnBlock/{pn}/{ps}/{sortBy}")
	public ResponseEntity<?> viewAllUnBlockRestaurant(@PathVariable("pn") int pageNo,@PathVariable("ps") int pageSize,@PathVariable String sortBy,@RequestBody RestaurantRequest request)
	{
		return this.service.viewAllUnBlockRestaurant(pageNo, pageSize, sortBy, request);
	}
	@PostMapping("/Block/{pn}/{ps}/{sortBy}")
	public ResponseEntity<?> viewAllBlockRestaurant(@PathVariable("pn") int pageNo,@PathVariable("ps") int pageSize,@PathVariable String sortBy,@RequestBody RestaurantRequest request)
	{
