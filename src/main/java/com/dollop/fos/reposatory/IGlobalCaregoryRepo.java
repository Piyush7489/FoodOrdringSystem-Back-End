...
//	
	...
	@Query("SELECT gc FROM GlobalCategory gc  join RestaurantCategory rc ON gc.catId= rc.globalCategory.catId WHERE rc.restaurant.restId=:restId AND gc.isActive=true")
